    ...
    <div class="container pt-12 pt-lg-6 pb-13 pb-md-15">
      ...
      <div class="row gy-6 gy-lg-0">
        <div class="col-md-4 col-lg-3">
          <div class="widget">
          <img src="assets/favicon-1.png" alt="" style="width:30%;"/>
            <p class="mb-4">© 2023 MauliVision. <br class="d-none d-lg-block" />All rights reserved.</p>
        ...
        <div class="col-md-4 col-lg-3">
          <div class="widget">
            ...
            <a href="cdn-cgi/l/email-protection.html#5d7e"><span class="__cf_email__" data-cfemail="345d5a525b745159555d581a575b59">[email&#160;protected]</span></a><br /> 00 (123) 456 78 90
          </div>
          <!-- /.widget -->
        </div>
        <!-- /column -->
